...
def read_pdf(file_path: str, page_range: Optional[Tuple[int, int]] = None)  -> dict:
    """Read PDF file.
    ...
    try:
        with open(file_path, 'rb') as f:
            ...
            for i in range(start, end+1):
                ...
                # Later we may consider calling other models to understand the pictures and return text descriptions.
                text_content[i] = text
...
if __name__ == '__main__':
    ...
    content = read_pdf(file_path, (1, 2))
    print(content)
