...
class LLMInteractor:
    ...
    def change_flashcard_manager(
        self, flashcard_manager: AbstractSRS[AbstractDeck, AbstractCard, AbstractTemporaryCollection]
    ):
        self.flashcard_manager = flashcard_manager
    ...
    def search_for_substring(
        ...
        if fuzzy is None or fuzzy == 0.0:
            ...
            searcher = SearchBySubstringFuzzy(
                search_substring, search_in_question, search_in_answer, case_sensitive, fuzzy
            )
