...
from src.backend.modules.srs.abstract_srs import AbstractSRS, DeckID, CardID, TmpCollectionID

# Easier words for the llm. The names are in the autogenerated prompt using @llm_command.
from src.backend.modules.srs.abstract_srs import AbstractDeck
...
class LLMInteractor:
    ...
    @llm_command(_commands)
    def list_decks(self, ) -> list[AbstractDeck]:
        """
    ...
    def _search(self, deck_id_str: str, searcher: AbstractCardSearcher,
                description: str) -> AbstractTemporaryCollection:
        """
    ...
    def search_for_substring(self, deck_id_str: str, search_substring: str, search_in_question: bool = True,
                             ...
                             fuzzy: Optional[float] = None) -> AbstractTemporaryCollection:
        """
        ...
        if fuzzy is None or fuzzy == 0.0:
            ...
            searcher = SearchBySubstringFuzzy(search_substring, search_in_question, search_in_answer, case_sensitive,
                                              fuzzy)
    ...
    def search_for_content(self, deck_id_str: str, search_prompt: str, search_in_question: bool = True,
                           search_in_answer: bool = True) -> AbstractTemporaryCollection:
        """
