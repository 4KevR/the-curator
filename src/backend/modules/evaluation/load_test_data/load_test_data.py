...
#
# The tests are parsed from the test.json, and are represented as TestFlashcardManagers – they are working
...
def _get_prompt_with_parameters(prompts: list[list[str]], parameters: dict[str, list[str]]) -> list[_ParsedPrompt]:
    """
...
def _expected_result_to_fcm(
    expected_result: _Test_ExpectedResult, parameter_replacements: dict[str, str], known_decks: dict[str, TestDeck]
